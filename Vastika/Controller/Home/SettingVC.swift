...
class SettingVC: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    @objc func onDoneButtonTapped()
    {
        ...
        if appDelegate.isFrom == "BLE"
        {
            ...
            let alert = UIAlertController(title: webServices.AppName, message: "Any setting change will change the default state of the UPS.", preferredStyle: UIAlertController.Style.alert)
            alert.addAction(UIAlertAction(title: "OK", style: .default, handler: { (action) in
    ...
    //=====================================================
     ...
     func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
         ...
         else if self.pickerView.tag == 99
         {
             ...
             self.selectedId = (dict?.object(forKey: "ide") as? String)!
             UserDefaults.standard.set((dict?.object(forKey: "name") as? String), forKey: "battery")
